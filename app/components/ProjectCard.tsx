            ...
            <div className='desktop:hidden mobile:flex border-t-[1px] border-b-[1px] border-[#3b3b3b] py-[30px] w-[100vw] max-w-[1570px] flex items-start justify-between'>
                <div className='flex gap-[50px] flex-col items-center'>
                    ...
                    <div className='flex flex-col items-center'>
                        ...
                        <div className='justify-center mt-[25px] flex flex-wrap gap-[30px] max-w-[600px] mt-[10px]'>
                    ...
                    <div className='flex  gap-[60px] justify-between h-[100%] h-[100%]'>
                        <Link href={deployedLink}
                            target='_blank'
                        >
                            <div className='flex gap-[10px]'>
                                <i className='text-[18px] font-bold text-white transition hover:text-green'>Deployed Link</i>
                                <Image
                                    src='/deployed.svg'
                                    width={24}
                                    height={24}
                        ...
                        >
                            <div className='flex gap-[10px] justify-end'>
                                <i className='text-[18px] font-bold text-white transition hover:text-green'>View Code</i>
                                <Image
                                    src='/viewCode.svg'
                                    width={24}
                                    height={24}
